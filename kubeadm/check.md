...
1. [Провести воспитательную беседу с devops](https://www.kryukov.biz/2022/07/pozhelaniya-devops-am/), которые используют ваш кластер.
2. Выделить под `/var/lib/containers` отдельный диск большого размера. Из моей практики хватало 100Gb при правильных devops инженерах.
