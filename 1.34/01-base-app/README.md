...
Проект достаточно старый. Использует в своей работе `Endpoints`, которые сейчас считаются устаревшими. При установке в новые кластера необходимо обратить внимание на это. Возможно в дальнейшем автор обновит приложение, возможно нет.
