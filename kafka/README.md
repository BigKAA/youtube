...
Но! чарт от битнами в одном месте не умеет работать с PEM форматом! Редиски! Поэтому есть три пути:

1. Подрихтовать один скрипт в чарте и потом всю жизнь следить за обновлениями чарта.
2. Написать свой, дополнительный инит контейнер и добавлять его в values чарта.
3. Готовит сикреты с сертификатами в файлах jks
